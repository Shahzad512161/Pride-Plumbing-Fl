...
export function JsonLd({ type, breadcrumbs }: JsonLdProps) {
  if (type === 'LocalBusiness') {
    const businessSchema = {
      ...
      "image": "https://pride-plumbing-fl.vercel.app/og-image.jpg", // default fallback
      "@id": "https://pride-plumbing-fl.vercel.app/#plumbing-service",
      "url": "https://pride-plumbing-fl.vercel.app",
      ...
      "geo": {
        "@type": "GeoCoordinates",
        "latitude": 26.1993, // Fort Lauderdale coordinates
        "longitude": -80.1259
      },
