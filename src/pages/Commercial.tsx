...
export function Commercial() {
  // SEO Setup
  useSeo({
    title: `Commercial Plumbing Services Florida | ${BUSINESS_INFO.name}`,
    description: `High-capacity commercial plumbing solutions for Florida businesses. Office, restaurant, retail, and industrial facilities. Licensed & certified team. Call ${BUSINESS_INFO.phone}.`,
    canonicalUrl: window.location.origin + '/plumbing/commercial'
  });
  ...
  const schemaCrumbs = [
    ...
    { name: 'Commercial', url: window.location.origin + '/plumbing/commercial' }
  ];
