...
export default function Residential() {
  const seoTitle = `Residential Plumbing Services Florida | ${BUSINESS_INFO.name}`;
  const seoDescription = `Expert residential plumbing services for Florida homeowners. Pipe repair, drain cleaning, water heaters, toilet/faucet fixtures. Fast response, transparent pricing.`;
  ...
  const schemaCrumbs = [
    ...
    { name: 'Residential', url: origin + '/plumbing/residential' }
  ];
