...
export default function Emergency() {
  const seoTitle = `24/7 Emergency Plumbing Florida | ${BUSINESS_INFO.name}`;
  const seoDescription = `Urgent 24/7 emergency plumbing response across Florida. We fix burst pipes, active flooding, gas leaks, and blocked sewers immediately. Licensed plumbers. Call ${BUSINESS_INFO.phone}.`;
  ...
  const schemaCrumbs = [
    ...
    { name: 'Emergency', url: origin + '/plumbing/emergency' }
  ];
