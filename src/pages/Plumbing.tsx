...
export function Plumbing() {
  // SEO
  useSeo({
    title: `Plumbing Services | ${BUSINESS_INFO.name}`,
    description: `Browse all residential, commercial, and emergency plumbing services offered by ${BUSINESS_INFO.name}. Licensed plumbers in Florida. Upfront quotes, 24/7 service.`,
    canonicalUrl: window.location.origin + '/plumbing'
  });
