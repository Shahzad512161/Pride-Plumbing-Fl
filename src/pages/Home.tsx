...
export function Home() {
  // Page SEO Setup
  useSeo({
    title: `${BUSINESS_INFO.name} | Florida's Premium Residential & Commercial Plumbing`,
    description: `Need an expert plumber in Florida? ${BUSINESS_INFO.name} offers 24/7 emergency service, residential, and commercial plumbing. Fully licensed and insured. Call ${BUSINESS_INFO.phone}.`,
