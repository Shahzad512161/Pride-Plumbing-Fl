...
export default function PrivacyPolicy() {
  ...
  const seoTitle = `Privacy Policy | ${BUSINESS_INFO.name}`;
  const seoDescription = `Read the Privacy Policy of ${BUSINESS_INFO.name}. Learn how we collect, store, and protect your information in compliance with Florida regulations.`;
