...
export default function TermsOfService() {
  ...
  const seoTitle = `Terms of Service | ${BUSINESS_INFO.name}`;
  const seoDescription = `Read the Terms of Service for ${BUSINESS_INFO.name}. Learn about our upfront pricing, warranties, work authorizations, and Florida regulatory compliance.`;
