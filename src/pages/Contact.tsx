      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10">
        <div className="bg-red-50 border-2 border-red-200 rounded-xl p-6 flex flex-col md:flex-row items-center justify-between gap-6 shadow-sm">
          ...
          <div className="w-full md:w-auto">
            ...
            >
              <LucideIcon name="Phone" className="h-4 w-4 animate-bounce" />
        ...
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fadeIn">
          <div className="bg-white rounded-xl border border-red-200 max-w-md w-full p-6 shadow-2xl relative">
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              <div className="h-12 w-12 rounded bg-red-100 text-red-600 flex items-center justify-center animate-pulse">
              ...
              <div className="flex gap-3 w-full pt-2">
                <button
                  onClick={() => setShowEmergencyModal(false)}
                  className="flex-1 py-2.5 bg-slate-100 hover:bg-slate-250 text-slate-700 font-bold rounded-lg text-xs transition-colors"
                >
                  Continue Form
                </button>
                <a
